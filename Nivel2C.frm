...
Private Sub pctCuadro_DragDrop(Index As Integer, Source As Control, X As Single, Y As Single)
    ...
    Select Case Index
       'NARANJA
       '------------------------------------------------------------
        Case 25, 32, 35, 37, 46, 48, 49, 63
            If Color = 0 Then
                If pctCuadro(Index).BackColor <> vbOrange Then
                    pctCuadro(Index).BackColor = vbOrange
                    Aciertos = Aciertos + 1
                End If
            End If
            Intentos = Intentos + 1
       ...
       'CELESTE
       '------------------------------------------------------------
        Case 28, 29, 34, 47, 53, 61
            If Color = 2 Then
                If pctCuadro(Index).BackColor <> vbCyan Then
                    pctCuadro(Index).BackColor = vbCyan
                    Aciertos = Aciertos + 1
                End If
            End If
            Intentos = Intentos + 1
       ...
       'BLANCO
       '------------------------------------------------------------
        Case 38, 39, 50, 51, 60, 62
            If Color = 4 Then
                If pctCuadro(Index).BackColor <> vbWhite Then
                    pctCuadro(Index).BackColor = vbWhite
                    Aciertos = Aciertos + 1
                End If
            End If
            Intentos = Intentos + 1
